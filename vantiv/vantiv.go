...
func (t *PartnerChaincode) readAllReferrals(stub *shim.ChaincodeStub) ([]byte, error) {
	...
	var activeReferrals []VantivReferral
	var declinedReferrals []VantivReferral
	var pendingReferrals []VantivReferral
